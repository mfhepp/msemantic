...
class Semantium_MSemanticBasic_Model_RDFs extends Mage_Core_Model_Abstract
{
	...
	public function comment($value, $lang="en")
	{
		...
		$rdfsComment = $this->rdff->property("rdfs:comment", $value, NULL, $lang);
		return $rdfsComment;
	}
	
	public function pName($value, $lang="en")
	{
		$rdfsComment = $this->rdff->property("gr:name", $value, NULL, $lang);
		return $rdfsComment;
	}
	...
	public function pDesc($value, $lang="en")
	{
		...
		$rdfsComment = $this->rdff->property("gr:description", $value, NULL, $lang);
		return $rdfsComment;
	}
